...
export const SUBTITLE_STYLE_DEFINITIONS: SubtitleStyleDefinition[] = [
  ...
  },
  {
    id: 'hf-caption-pill',
    name: '药丸底栏（HF）',
    description: 'HyperFrames 药丸底栏卡拉 OK 风格，节奏感口播',
    preview: {
      text: '全场五折 仅限今天',
      color: '#2563eb',
      bg: '#e7e5e7',
    ...
    engine: 'hyperframes',
    hf_component: 'caption-pill-karaoke',
    hf_fallback_id: 'subtitle-card',
  },
  {
    id: 'hf-caption-neon',
    name: '霓虹发光（HF）',
    description: 'HyperFrames 霓虹发光逐词字幕，科技年轻化',
    preview: {
      text: '智能导购 即刻体验',
      color: '#ffffff',
      bg: 'transparent',
    ...
    engine: 'hyperframes',
    hf_component: 'caption-neon-glow',
    hf_fallback_id: 'gradient-glow',
  },
  {
    id: 'hf-caption-editorial',
    name: '杂志强调（HF）',
    description: 'HyperFrames 杂志感强调字幕，适合高端美妆母婴',
    preview: {
      text: '匠心品质 尊享之选',
      color: '#f5f0d0',
      bg: 'transparent',
    ...
    engine: 'hyperframes',
    hf_component: 'caption-editorial-emphasis',
    hf_fallback_id: 'brand-elegant',
  },
  {
    id: 'hf-caption-gradient',
    name: '渐变填充（HF）',
    description: 'HyperFrames 渐变扫光字幕，适合大促活动',
    preview: {
      text: '年终盛典 惊喜不断',
      color: '#fde68a',
      bg: 'transparent',
  ...
  },
  {
    ...
    name: '矩阵解码（HF）',
    description: 'HyperFrames 矩阵乱码逐词解码字幕，科技未来感',
    preview: {
      text: '智能算法 实时推荐',
      color: '#00ff41',
      bg: 'transparent',
    ...
    engine: 'hyperframes',
    hf_component: 'caption-matrix-decode',
    hf_fallback_id: 'bold-yellow',
  },
  {
    id: 'hf-caption-emoji-pop',
    name: 'Emoji 弹出（HF）',
    description: 'HyperFrames Emoji 强调弹出字幕，活泼年轻化',
    preview: {
      text: '限时福利 快来抢购',
      color: '#ffffff',
      bg: 'transparent',
    ...
    engine: 'hyperframes',
    hf_component: 'caption-emoji-pop',
    hf_fallback_id: 'bold-yellow',
  },
  {
    id: 'hf-caption-glitch-rgb',
    name: 'RGB 故障（HF）',
    description: 'HyperFrames RGB 色差故障风字幕，潮流酷感',
    preview: {
      text: '炸裂来袭 潮酷登场',
      color: '#ffffff',
      bg: 'transparent',
    ...
    engine: 'hyperframes',
    hf_component: 'caption-glitch-rgb',
    hf_fallback_id: 'bold-white-stroke',
  },
  {
    id: 'hf-caption-kinetic-slam',
    name: '动能撞击（HF）',
    description: 'HyperFrames 全屏单词撞击入场字幕，强节奏冲击力',
    preview: {
      text: '爆款',
      color: '#ffffff',
      bg: 'transparent',
    ...
    engine: 'hyperframes',
    hf_component: 'caption-kinetic-slam',
    hf_fallback_id: 'bold-white-stroke',
  },
  {
    id: 'hf-caption-neon-accent',
    name: '霓虹强调（HF）',
    description: 'HyperFrames 多彩霓虹光晕强调字幕，夜间潮流',
    preview: {
      text: '闪耀时刻 全场聚焦',
      color: '#ffffff',
      bg: 'transparent',
    ...
    engine: 'hyperframes',
    hf_component: 'caption-neon-accent',
    hf_fallback_id: 'gradient-glow',
  },
  {
    id: 'hf-caption-parallax-layers',
    name: '视差层叠（HF）',
    description: 'HyperFrames 前后层叠拉伸强调字幕，杂志大片感',
    preview: {
      text: '品质之选',
      color: '#eeeeee',
      bg: 'transparent',
    ...
    engine: 'hyperframes',
    hf_component: 'caption-parallax-layers',
    hf_fallback_id: 'brand-elegant',
  },
  {
    id: 'hf-caption-particle-burst',
    name: '粒子爆炸（HF）',
    description: 'HyperFrames 关键词粒子爆炸字幕，促销高燃',
    preview: {
      text: '超值优惠 立即抢',
      color: '#ffffff',
      bg: 'transparent',
    ...
    engine: 'hyperframes',
    hf_component: 'caption-particle-burst',
    hf_fallback_id: 'bold-yellow',
  },
  {
    id: 'hf-caption-texture',
    name: '质感纹理（HF）',
    description: 'HyperFrames 岩浆纹理遮罩字幕，单字全屏质感',
    preview: {
      text: '炽热',
      color: '#ffd0a0',
      bg: 'transparent',
    ...
    engine: 'hyperframes',
    hf_component: 'caption-texture',
    hf_fallback_id: 'bold-white-stroke',
  },
  {
    id: 'hf-caption-weight-shift',
    name: '字重切换（HF）',
    description: 'HyperFrames 优雅字重渐变字幕，轻奢高级感',
    preview: {
      text: '匠心品质 尊享生活',
      color: '#ffffff',
      bg: 'transparent',
    ...
    engine: 'hyperframes',
    hf_component: 'caption-weight-shift',
    hf_fallback_id: 'brand-elegant',
  },
];
