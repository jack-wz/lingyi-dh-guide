...
export const HF_STYLE_BINDINGS: HfStyleBinding[] = [
  ...
  {
    styleId: 'hf-caption-matrix-decode',
    hfName: 'caption-matrix-decode',
    slot: 'subtitle',
    fallbackStyleId: 'bold-yellow',
    verticalSafe: true,
    requiresGsap: true,
  ...
  {
    styleId: 'hf-caption-emoji-pop',
    hfName: 'caption-emoji-pop',
    slot: 'subtitle',
    fallbackStyleId: 'bold-yellow',
    verticalSafe: true,
    requiresGsap: true,
  ...
  {
    styleId: 'hf-caption-glitch-rgb',
    hfName: 'caption-glitch-rgb',
    slot: 'subtitle',
    fallbackStyleId: 'bold-white-stroke',
    verticalSafe: true,
    requiresGsap: true,
    brandTokenKeys: ['brand_color', 'accent_color'],
  },
  {
    styleId: 'hf-caption-kinetic-slam',
    hfName: 'caption-kinetic-slam',
    slot: 'subtitle',
    fallbackStyleId: 'bold-white-stroke',
    verticalSafe: true,
    requiresGsap: true,
  ...
  {
    styleId: 'hf-caption-neon-accent',
    hfName: 'caption-neon-accent',
    slot: 'subtitle',
    fallbackStyleId: 'gradient-glow',
    verticalSafe: true,
    requiresGsap: true,
  ...
  {
    styleId: 'hf-caption-parallax-layers',
    hfName: 'caption-parallax-layers',
    slot: 'subtitle',
    fallbackStyleId: 'brand-elegant',
    verticalSafe: true,
    requiresGsap: true,
  ...
  {
    styleId: 'hf-caption-particle-burst',
    hfName: 'caption-particle-burst',
    slot: 'subtitle',
    fallbackStyleId: 'bold-yellow',
    verticalSafe: true,
    requiresGsap: true,
  ...
  {
    styleId: 'hf-caption-texture',
    hfName: 'caption-texture',
    slot: 'subtitle',
    fallbackStyleId: 'bold-white-stroke',
    verticalSafe: true,
    requiresGsap: true,
  ...
  {
    styleId: 'hf-caption-weight-shift',
    hfName: 'caption-weight-shift',
    slot: 'subtitle',
    fallbackStyleId: 'brand-elegant',
    verticalSafe: true,
    requiresGsap: true,
